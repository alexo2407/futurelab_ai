...
<div class="row">
    ...
    <div class="col-sm-4 offset-2">
        <a href="index.php?enlaceBack=crearUsuario" class="btn btn-success w-100"><i class="bi bi-plus-circle-fill"></i> Nuevo Usuario</a>
    </div>    
</div>
            ...
            <table id="tblUsuarios" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?enlaceBack=editarUsuario&id=<?php echo $usuarios->id; ?>" class="btn btn-warning"><i class="bi bi-pencil-fill"></i></a>                                            
                        </td>
                    </tr>
